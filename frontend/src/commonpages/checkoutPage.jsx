        ...
        <section className="lg:col-span-7 bg-white rounded-[2.5rem] p-6 md:p-10 border border-white shadow-[0_20px_50px_-20px_rgba(0,0,0,0.1)]">
          ...
          <div className="space-y-8">
              ...
              <div className="flex flex-col gap-1.5 relative">
                ...
                <div className="relative">
                  ...
                  <div
                    ...
                    className={`w-full bg-white border ${isOpen ? 'border-[#007074] ring-4 ring-[#007074]/10' : 'border-[#E9DBD1]'} rounded-2xl py-[13px] px-4 text-sm font-semibold text-[#222222] outline-none flex items-center justify-between cursor-pointer transition-all shadow-sm hover:border-[#007074]/40`}
                  >
                    {selectedProvince}
                    <FiChevronDown className={`text-[#007074] transition-transform duration-300 ${isOpen ? 'rotate-180' : ''} text-lg`} />
                  </div>

                  {/* Custom List (Replaces the native blue menu) */}
                  {isOpen && (
                    <div className="absolute top-10 left-0 w-full mt-2 bg-white border border-[#E9DBD1] rounded-2xl shadow-xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                      {provinces.map((province) => (
                        <div
                          ...
                          className={`px-4 py-1 text-sm font-semibold transition-colors cursor-pointer
                    ${selectedProvince === province
                              ? 'bg-[#007074] text-white'
                              : 'text-[#222222] hover:bg-[#007074]/10 hover:text-[#007074]'
                            }`}
                        >
                          {province}
                        </div>
            ...
            <div className="md:pt-4">
              ...
              <div className="border-2 border-[#007074] bg-[#007074]/5 rounded-2xl p-2 md:p-5 flex items-center justify-between shadow-[0_10px_30px_-10px_rgba(0,112,116,0.15)]">
            ...
            <button className="w-full bg-[#222] text-white py-2.5 md:py-4.5 rounded-full md:font-black font-semibold md:uppercase tracking-[0.2em] text-xs md:mt-4 hover:bg-[#007074] hover:shadow-[0_20px_40px_-10px_rgba(0,112,116,0.4)] transform transition-all hover:-translate-y-1 active:scale-[0.98]">
          ...
          <div className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.08)] relative overflow-hidden">
            ...
            <div className="space-y-3 pt-6 border-t border-dashed border-gray-200 text-xs">
              ...
              <div className="flex justify-between items-end pt-5 mt-2 border-t border-gray-100">
                ...
                <span className="text-xl md:text-2xl font-serif font-black text-[#007074] leading-none">${total.toFixed(2)}</span>
              </div>
            </div>
